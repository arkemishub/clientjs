    ...
    <header className="border-b-background-400 bg-background sticky top-0 z-30 hidden border-b-2 py-4 md:block">
      <div className="flex items-center gap-8 px-8">
        <div className="flex items-center gap-2">
          ...
          <p className="font-semibold">arkejs/client</p>
        </div>
        <nav>
          <ul>
            {navbarConfig.map(({ title, href }) => (
              <li
                key={href}
                className="text-neutral hover:text-foreground transition-all"
              >
        ...
        <div className="ml-auto flex items-center">
          <a
            href="https://github.com/arkemishub/clientjs"
